...
public class RecipeController {
	...
	@PostMapping("/add")
	private ResponseEntity<?> addRecipe(@RequestBody RecipeRequestDto recipeDto) {
	...
	@PutMapping
	private ResponseEntity<?> updateRecipe(@RequestBody RecipeRequestDto recipeRequestDto) {
